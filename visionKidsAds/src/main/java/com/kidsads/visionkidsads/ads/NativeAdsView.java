...
public class NativeAdsView extends LinearLayout {
    private static final String TAG = NativeAdsView.class.getSimpleName();
    ...
    private static void populateUnifiedNativeAdView(Activity activity, NativeAd nativeAd, FrameLayout frameLayout) {
        ...
        NativeAdView adView = (NativeAdView) activity.getLayoutInflater().inflate(R.layout.admob_native_ads, null);
    ...
    public void showCustomNativeAd(Activity activity, FrameLayout frameLayout, ShimmerFrameLayout shimmer) {
        ...
        shimmer.stopShimmer();
        LayoutInflater inflater = LayoutInflater.from(activity);
        customView = inflater.inflate(R.layout.custom_native_ads, frameLayout, false);
