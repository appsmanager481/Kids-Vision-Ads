...
public class SmallNativeAdsView extends LinearLayout {
    private static final String TAG = SmallNativeAdsView.class.getSimpleName();
    ...
    private static void populateUnifiedNativeAdView2(Activity activity, NativeAd nativeAd, FrameLayout frameLayout) {
        ...
        if (nativeAd.getBody() == null) {
            ...
            if (!PrefLibAds.getInstance().getString("appAdsTextColor").equals("")) {
                ...
                ((TextView) adView.getBodyView()).setTextColor(ColorStateList.valueOf(Color.parseColor("#000000")));
            }
        }
