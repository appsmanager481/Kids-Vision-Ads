...
public class TopNativeAdsView extends LinearLayout {
    private static final String TAG = TopNativeAdsView.class.getSimpleName();
    ...
    public TopNativeAdsView(Context context) {
        this(context, null);
    }

    public TopNativeAdsView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("CustomViewStyleable")
    public TopNativeAdsView(Context context, AttributeSet attrs, int defStyle) {
        ...
        View.inflate(context, R.layout.main_top_native_layout, this);
        try {
    ...
    private static void populateUnifiedNativeAdView(Activity activity, NativeAd nativeAd, FrameLayout frameLayout) {
        ...
        NativeAdView adView = (NativeAdView) activity.getLayoutInflater().inflate(R.layout.admob_top_native_ads, null);
    ...
    public void showMoreAppAds(Activity activity, FrameLayout frameLayout) {
        ...
        moreView = inflater.inflate(R.layout.main_more_big_app_ads, frameLayout, false);
        ...
        if (retrievedData != null && !retrievedData.isEmpty()) {
            for (int i = 0; i < retrievedData.size(); i++) {
                ...
                MoreAppAdapter moreAppAdapter = new MoreAppAdapter(activity, retrievedData, R.layout.item_big_more_app_cat);
    ...
    public void showCustomNativeAd(Activity activity, FrameLayout frameLayout, ShimmerFrameLayout shimmer) {
        ...
        shimmer.stopShimmer();
        LayoutInflater inflater = LayoutInflater.from(activity);
        View customView = inflater.inflate(R.layout.custom_native_top_ads, frameLayout, false);
